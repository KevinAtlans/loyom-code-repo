 ...
 * 
 * Notes: Create a ConnectionList with a Selector and then use push, remove, and
 * remove first to add or remove connected SocketChannels and attach/detach them
 * to/from their Selector.
 */
class ConnectionList<T> {

    private final LinkedList<T> list = new LinkedList<T>();

    private final Selector selectorToNotify;

    /*
     * Construct a new Connection list which will attach SocketChannels to the
     * specified Selector
     */
    ...
    /*
     * Add a SocketChannel to the list and wake up the selector.
     * 
