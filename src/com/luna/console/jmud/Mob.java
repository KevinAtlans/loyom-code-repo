...
public class Mob implements Target {
     ...
     */
    public Mob(int iID, MobType mobType, int iHP, int iMaxHP, int iAC, int iStrength, int iDexterity) {
    ...
    public boolean hurt(int iDmg) {
        ...
        // bAlive = !(iHP > 0);
        // Scratch that: we'll complicate this and set it in the return
        // statement :) (yeah, yeah, so shoot me)
