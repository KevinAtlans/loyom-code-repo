package com.luna.console.jmud.item;
...
public class Item {
    ...
    public Item(int id, String name) {
        ...
        this(id, name, DEFAULT_BULK, DEFAULT_WEIGHT, DEFAULT_USES, DEFAULT_CONDITION,
                new LinkedList<Slot>());
    }
     ...
     * 
     * @param o
     *            The other item to check this item against
     */
    @Override
    public boolean equals(Object o) {
        ...
        // March 20, 2003
        /**
         * I left this open and used hashCode() to compare the two objects
         * because I didn't want to have to change BOTH methods (equals and
         * hashCode) if I ever wanted to change how hashCode() (and thus
     ...
     * 
     * @param uses
     *            how many usages to apply to the item
