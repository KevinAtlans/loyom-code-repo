...
/**
 * This thread tracks a list of commands that have submitted for processing and
 * processes the commands at a specified interval. Commands are added directly
 * to the Linked List that is used in the constructor.
 * 
 * @author Chris Maguire
 * @version 0.1
 *          <p/>
 *          ToDO: Have the EngineThread manage it's own LinkedList so that we
 *          don't have to pass it around separately.
 */
class EngineThread extends Thread {
    ...
    /**
     * Constructs an engine thread with a LinkedList onto which will be added
     * commands and the number of milliseconds between command execution loops
     * (the "tick" delay)
     * 
     * @param commands
     *            The list of commands that are to be processed
     * @param millis
     *            The number of milliseconds between each command execution loop
     */
    ...
    /**
     * The Tick class is a singleton that simply executes any commands that are
     * in the command LinkedList.
     */
    public class Tick extends TimerTask {
        ...
        /**
         * Constructs a Tick with the LinkedList where new commands will be
         * stored
         * 
         * @param commands
         *            The LinkedList where new command objects are stored.
         */
        ...
        public void run() {
            ...
            // only mess with the commands linked list when we have exclusive
            // access
            ...
            while (!currentCommands.isEmpty()) {
                ...
                // if the command isn't finished then add it too the end of the
                // list
