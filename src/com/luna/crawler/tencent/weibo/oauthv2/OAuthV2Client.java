package com.luna.crawler.tencent.weibo.oauthv2;
...
public class OAuthV2Client {
    ...
    public static boolean setAuthorization(String authorizeCode, String openid, String openkey,
        ...
        if ((!QStrOperate.hasValue(authorizeCode)) || (!QStrOperate.hasValue(openid))
    ...
    public static boolean parseAuthorization(String responseData, OAuthV2 oAuth) {
        ...
        for (int i = 0; i < tokenArray.length; i++) {
            if (tokenArray[i].startsWith("code=")) {
                oAuth.setAuthorizeCode(tokenArray[i].substring(tokenArray[i].indexOf('=') + 1,
                        tokenArray[i].length()));
            }
