package com.luna.crawler.tencent.weibo.utils;
...
public class QHttpClient {
     ...
     *            代理设置，若无请填null
     */
    public QHttpClient(int maxConnectionsPerHost, int maxTotalConnections, int conTimeOutMs,
            int soTimeOutMs, List<RouteCfg> routeCfgList, HttpHost proxy) {
    ...
    public String httpPost(String url, String queryString) throws Exception {
        ...
        URI uri = URIUtils.createURI(tmpUri.getScheme(), tmpUri.getHost(), tmpUri.getPort(),
                tmpUri.getPath(), queryString, null);
