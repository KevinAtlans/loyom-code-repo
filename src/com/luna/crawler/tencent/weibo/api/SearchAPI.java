...
public class SearchAPI extends BasicAPI {
     ...
     * @param msgtype
     *            消息的类型（按位使用） 0-所有，1-原创发表，2
     *            转载，8-回复(针对一个消息，进行对话)，0x10-空回(点击客人页，进行对话)
     * @param searchtype
     *            搜索类型 <li>0-默认搜索类型（现在为模糊搜索） <li>
     ...
     * @param starttime
     *            开始时间，用UNIX时间表示（从1970年1月1日0时0分0秒起至现在的总秒数） endtime
     ...
     */
    public String t(OAuth oAuth, String format, String keyword, String pagesize, String page,
            String contenttype, String sorttype, String msgtype, String searchtype,
            String starttime, String endtime, String province, String city, String longitue,
        ...
        return requestAPI.getResource(searchTUrl, paramsList, oAuth);
    }
