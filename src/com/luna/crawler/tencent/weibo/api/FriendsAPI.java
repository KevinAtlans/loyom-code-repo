...
import com.luna.crawler.tencent.weibo.beans.OAuth;
import com.luna.crawler.tencent.weibo.utils.QArrayList;
...
public class FriendsAPI extends BasicAPI {
     ...
     * @param mode
     *            获取模式，默认为0 <li>mode=0，旧模式，新粉丝在前，只能拉取1000个 <li>
     ...
     */
    public String fanslist(OAuth oAuth, String format, String reqnum, String startindex,
            String mode, String install) throws Exception {
        ...
        return requestAPI.getResource(friendsFansListUrl, paramsList, oAuth);
    }
     ...
     */
    public String idollist(OAuth oAuth, String format, String reqnum, String startindex,
        ...
        return requestAPI.getResource(friendsIdolListUrl, paramsList, oAuth);
    }
    ...
    public String add(OAuth oAuth, String format, String name, String fopenids) throws Exception {
        ...
        return requestAPI.postContent(friendsAddUrl, paramsList, oAuth);
    }
    ...
    public String del(OAuth oAuth, String format, String name, String fopenid) throws Exception {
        ...
        return requestAPI.postContent(friendsDelUrl, paramsList, oAuth);
    }
    ...
    public String check(OAuth oAuth, String format, String names, String fopenids, String flag)
        ...
        return requestAPI.getResource(friendsCheckUrl, paramsList, oAuth);
    }
     ...
     */
    public String userFanslist(OAuth oAuth, String format, String reqnum, String startindex,
            String name, String fopenid, String mode, String install) throws Exception {
        ...
        return requestAPI.getResource(friendsUserFansListUrl, paramsList, oAuth);
    }
     ...
     */
    public String userIdollist(OAuth oAuth, String format, String reqnum, String startindex,
            String name, String fopenid, String install) throws Exception {
        ...
        return requestAPI.getResource(friendsUserIdolListUrl, paramsList, oAuth);
    }
     ...
     */
    public String userSpeciallist(OAuth oAuth, String format, String reqnum, String startindex,
            String name, String fopenid, String install) throws Exception {
        ...
        return requestAPI.getResource(friendsUserSpecialListUrl, paramsList, oAuth);
    }
     ...
     */
    public String fanslistS(OAuth oAuth, String format, String reqnum, String startindex,
            String install) throws Exception {
        ...
        return requestAPI.getResource(friendsFansListSUrl, paramsList, oAuth);
    }
