...
public class UserAPI extends BasicAPI {
    ...
    public String info(OAuth oAuth, String format) throws Exception {
        ...
        return requestAPI.getResource(userInfoUrl, paramsList, oAuth);
    }
    ...
    public String otherInfo(OAuth oAuth, String format, String name, String fopenid)
        ...
        return requestAPI.getResource(userOtherInfoUrl, paramsList, oAuth);
    }
     ...
     *            返回数据的格式 是（json或xml）
     * @param names
     *            用户ID列表 比如 abc,edf,xxxx（最多30，可选）
     * @param fopenids
     *            你需要读取的用户openid列表，用下划线“_”隔开，<br>
     *            例如：
     ...
     */
    public String infos(OAuth oAuth, String format, String names, String fopenids) throws Exception {
