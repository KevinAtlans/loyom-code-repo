...
import com.luna.crawler.tencent.weibo.oauthv2.OAuthV2;
import com.luna.crawler.tencent.weibo.oauthv2.OAuthV2Client;
...
public class TestOAuthV2AuthorizeCodeGrantAndAPI {
    ...
    private void testList() throws Exception {
        ...
        response = tAPI.addPic(oAuth, format, "发表一条带网络图片的微博" + content, clientip, jing, wei,
